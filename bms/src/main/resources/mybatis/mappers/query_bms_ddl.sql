...
CREATE TABLE T_SHOPPING_GOODS(
	...
	GOODS_CONTENTS_ORDER 	VARCHAR2(2000),
...
CREATE TABLE T_SHOPPING_CART(
    ...
    CART_GOODS_QTY 	NUMBER(4),
    CRE_DATE 		DATE,
    CONSTRAINT CART_FK_GOODS_ID FOREIGN KEY (GOODS_ID)
    REFERENCES T_SHOPPING_GOODS (GOODS_ID),
    CONSTRAINT CART_FK_MEMBER_ID FOREIGN KEY (MEMBER_ID)
    REFERENCES T_SHOPPING_MEMBER (MEMBER_ID)
